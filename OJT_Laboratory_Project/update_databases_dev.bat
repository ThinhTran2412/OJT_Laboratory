...
powershell -Command "Write-Host '==============================================================' -ForegroundColor Cyan"
powershell -Command "Write-Host ''"
powershell -Command "Write-Host 'WARNING: If you see \"relation already exists\" errors,' -ForegroundColor Yellow"
powershell -Command "Write-Host '         it means tables exist but migrations are not recorded.' -ForegroundColor Yellow"
powershell -Command "Write-Host '         Solution: Run clean_all_migrations.bat first, then' -ForegroundColor Yellow"
powershell -Command "Write-Host '                  create and apply migrations again.' -ForegroundColor Yellow"
powershell -Command "Write-Host ''"
...
REM ====================================================================
powershell -Command "Write-Host '[1/5] IAM_Service Migration (DEV)' -ForegroundColor DarkCyan"
...
REM ====================================================================
powershell -Command "Write-Host '[2/5] Laboratory_Service Migration (DEV)' -ForegroundColor DarkCyan"
powershell -Command "Write-Host '--------------------------------------------------------------' -ForegroundColor DarkGray"
...
REM ====================================================================
powershell -Command "Write-Host '[3/5] Monitoring_Service Migration (DEV)' -ForegroundColor DarkCyan"
powershell -Command "Write-Host '--------------------------------------------------------------' -ForegroundColor DarkGray"
...
REM ====================================================================
powershell -Command "Write-Host '[4/5] Simulator_Service Migration (DEV)' -ForegroundColor DarkCyan"
powershell -Command "Write-Host '--------------------------------------------------------------' -ForegroundColor DarkGray"
...
REM ====================================================================
powershell -Command "Write-Host '[5/5] WareHouse_Service Migration (DEV)' -ForegroundColor DarkCyan"
powershell -Command "Write-Host '--------------------------------------------------------------' -ForegroundColor DarkGray"
