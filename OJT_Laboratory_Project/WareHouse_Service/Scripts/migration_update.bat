@echo off
REM Batch script to update database migration for WareHouse_Service.API
...
powershell -Command "Write-Host 'Project: WareHouse_Service.API' -ForegroundColor DarkCyan"
echo.
...
dotnet build WareHouse_Service.sln --configuration Release --no-restore >nul 2>&1
