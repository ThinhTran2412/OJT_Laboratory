@echo off
REM ====================================================================
REM Script to CREATE new migration for WareHouse_Service
...
REM Change to WareHouse_Service directory (go up two levels from pro folder)
cd /d "%~dp0\..\.."
...
if not exist "WareHouse_Service.sln" (
    ...
    powershell -Command "Write-Host 'Please run this script from WareHouse_Service\Scripts\pro folder.' -ForegroundColor Yellow"
    exit /b 1
)

powershell -Command "Write-Host ''"
powershell -Command "Write-Host '==============================================================' -ForegroundColor Cyan"
powershell -Command "Write-Host '  Creating WareHouse_Service Migration (PRODUCTION)' -ForegroundColor Cyan"
...
if %ERRORLEVEL% equ 0 (
    powershell -Command "Write-Host ''"
    powershell -Command "Write-Host '✓ WareHouse_Service migration created successfully!' -ForegroundColor DarkGreen"
