@echo off
REM Batch script to clean bin, obj, and Visual Studio files for WareHouse_Service
setlocal enabledelayedexpansion

REM Change to project root directory
cd /d "%~dp0\.."

powershell -Command "Write-Host '=== Cleaning WareHouse_Service ===' -ForegroundColor DarkCyan"
echo.
...
dotnet clean WareHouse_Service.sln --verbosity quiet
