@echo off
REM Batch script to clean bin, obj, and Visual Studio files for Simulator_Service
setlocal enabledelayedexpansion

REM Change to project root directory
cd /d "%~dp0\.."

powershell -Command "Write-Host '=== Cleaning Simulator_Service ===' -ForegroundColor DarkCyan"
echo.
...
dotnet clean Simulator_Service.sln --verbosity quiet
