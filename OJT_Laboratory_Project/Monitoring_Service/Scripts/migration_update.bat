@echo off
REM Batch script to update database migration for Monitoring_Service.API
...
powershell -Command "Write-Host 'Project: Monitoring_Service.API' -ForegroundColor DarkCyan"
echo.
...
dotnet build Monitoring_Service.API/Monitoring_Service.API.csproj --configuration Release --no-restore >nul 2>&1
