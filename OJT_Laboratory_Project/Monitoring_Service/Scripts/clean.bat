@echo off
REM Batch script to clean bin, obj, and Visual Studio files for Monitoring_Service
setlocal enabledelayedexpansion

REM Change to project root directory
cd /d "%~dp0\.."

powershell -Command "Write-Host '=== Cleaning Monitoring_Service ===' -ForegroundColor DarkCyan"
echo.
...
dotnet clean Monitoring_Service.API/Monitoring_Service.API.csproj --verbosity quiet
